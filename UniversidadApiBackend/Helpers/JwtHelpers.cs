    ...
    public static class JwtHelpers
    {
        public static IEnumerable<Claim> GetClaims(this UserTokens userAccount, Guid Id) {
            List<Claim> claims = new List<Claim>() {
                ...
                new Claim (ClaimTypes.Email, userAccount.EmailId.ToString()),
        ...
        // Obtener el token
        public static UserTokens GenTokeKey(UserTokens model, JwtSettings jwtSettings) {
            try
            {
